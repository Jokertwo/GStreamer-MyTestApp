...
//                GraphicsConfiguration gc = getGraphicsConfiguration();
    ...
    /**
     * Renders to a volatile image, and then paints that to the screen. This helps with scaling performance on
     * accelerated surfaces (e.g. OpenGL)
     *
     * @param g
    ...
    /**
     * Renders directly to the given <tt>Graphics</tt>. This is only really useful on MacOS where swing graphics are
     * unaccelerated so using a volatile just incurs an extra memcpy().
     *
     * @param g
     *            the graphics to paint the image to
     * @param x
